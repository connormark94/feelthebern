...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Book Bern — Male Vocalist & Wedding Singer" },
      { name: "description", content: "Book professional male vocalist Bern for weddings, parties and corporate events across the UK and internationally. Northwest UK singer with 20+ years performing — personal reply within 24 hours." },
      { name: "keywords", content: "book northwest uk singer, hire male vocalist, book wedding singer, party singer hire, corporate event vocalist, UK male singer, international event singer, destination wedding singer" },
      { property: "og:title", content: "Book Bern — Male Vocalist & Wedding Singer" },
      { property: "og:description", content: "Book professional male vocalist Bern for weddings, parties and corporate events across the UK and internationally. Northwest UK singer with 20+ years performing." },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "https://bernieventsinger.co.uk/contact" },
      ...
      { name: "twitter:title", content: "Book Bern — Male Vocalist & Wedding Singer" },
      { name: "twitter:description", content: "Book professional male vocalist Bern for weddings, parties and corporate events across the UK and internationally. Northwest UK singer with 20+ years performing." },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          about: "Booking a professional Northwest UK singer and male vocalist for weddings, parties and corporate events in the UK and internationally.",
        }),
      },
    ],
  }),
    ...
    <SiteLayout>
      ...
      <section className="max-w-6xl mx-auto px-5 sm:px-8 py-16 grid lg:grid-cols-5 gap-10">
        ...
        <aside className="lg:col-span-2 space-y-4">
          ...
          <InfoCard icon={MapPin} label="Based in" value="Northwest UK — available worldwide" />
